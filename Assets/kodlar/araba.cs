...
public class araba : MonoBehaviour
{
    ...
    private void Update() {
        if(kaybettinpanel != null){
            if(kaybettinpanel.activeSelf){driftFactor = 0;maxSpeed = 0; accelerationFactor = 0; turnFactor = 0;}
        }

        if(kazandinpanel != null){
             if(kazandinpanel.activeSelf){driftFactor = 0;maxSpeed = 0; accelerationFactor = 0; turnFactor = 0;}
        }
